...
export async function deleteAccountConversation(
  ...
  const warningText =
    ...
    "Если ты хочешь сохранить свои записи перед удалением, сначала воспользуйся кнопкой *«Экспорт записей»* в главном меню, а затем возвращайся к удалению аккаунта.\n\n" +
